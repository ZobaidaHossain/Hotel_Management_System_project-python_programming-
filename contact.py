...
def DisplayForm():
    ...
    display_screen.title("ROOM SERVICE")
    global tree
    global SEARCH
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="Room Service", font=('verdana', 18), width=600,bg="cyan")
    ...
    Label(LFrom, text="Service ", font=("Arial", 12),bg="#15244C",fg="white").pack(side=TOP)
    lname.set("Select service")
    content = {'staff provide', 'delivery service', 'Laundry service', 'food delivery', 'Snak Bar Service', 'Buffet Service', 'Cafeteria Service', 'Table Service', 'Mobile Pantries'}
    OptionMenu(LFrom, lname, *content).pack(side=TOP, padx=10, fill=X)
    ...
    Label(LFrom, text="Room Number ", font=("Arial", 12),bg="#15244C",fg="white").pack(side=TOP)
    ...
    tree.heading('Contact', text="Service", anchor=W)
    tree.heading('Email', text="Gender", anchor=W)
    tree.heading('Rollno', text="Room Number", anchor=W)
