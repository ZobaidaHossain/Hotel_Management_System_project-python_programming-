...
def chk_mo():
    while True:
        ...
        if mobile_no.isdigit() == True and len(mobile_no) != 0 and len(mobile_no) == 10:#0-10 mot 11
            return mobile_no
            break
        else:
            print("invalid input ")
...
class save:
    ...
    def bill(self):
        print("\n")
        print("@@@@@@@@@  PALACE HOTEL AND RESORTS  @@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@ YOUR SAFETY AND COMFORT IS HERE @@@@@@@@@@@@@@@@@@")
