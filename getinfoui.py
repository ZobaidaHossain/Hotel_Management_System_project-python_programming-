    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                if int(self.gettininfo) > 50 or int(self.gettininfo) < 1:
                    self.Text1.insert(INSERT, " No such room exists!! ""\n")
                    return
                else:
                    self.Text1.insert(INSERT, " Looking for room ""\n")
                ...
                try:
                    ...
                    while True:
                        ...
                        if self.gettininfo == a:
                            ...
                            print("\n")
                            print("TOTAL BILL IS BDT.", s.price)
                        elif EOFError:
                            if n == 0:
